...
const port = 3000;
    ...
    (async () => {
        ...
        const config = {
            baseSiteUrl: `https://nodejs.org/docs/latest-v13.x/api/esm.html#esm_package_json_type_field`,
            startUrl: `https://nodejs.org/docs/latest-v13.x/api/esm.html#esm_package_json_type_field`,
            filePath: './images/',
        ...
        writeFile('./articles.json', JSON.stringify(articles), () => { })//Will produce a formatted JSON containing all article pages and their selected data.

        writeFile('./stories.json', JSON.stringify(stories), () => { })
